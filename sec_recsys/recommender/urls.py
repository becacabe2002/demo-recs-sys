...
urlpatterns = [
    ...
    path('association_rule/<str:content_id>/',
    ...
    path('sim/user/<str:user_id>/<str:sim_method>/',
         views.similar_users, name='similar_users'),
    path('cb/item/<str:content_id>/',
         views.similar_content, name='similar_content'),
    path('cb/user/<str:user_id>/',
         views.recs_cb, name='recs_cb'),
    path('cf/user/<str:user_id>/',
         views.recs_cf, name='recs_cb'),
    path('basemf/user/<str:user_id>/',
         views.recs_basemf, name='recs_basemf'),
    path('fwls/user/<str:user_id>/',
         views.recs_fwls, name='recs_fwls'),
    path('bpr/user/<str:user_id>/',
         views.recs_bpr, name='recs_bpr'),
    path('pop/user/<str:user_id>/',
